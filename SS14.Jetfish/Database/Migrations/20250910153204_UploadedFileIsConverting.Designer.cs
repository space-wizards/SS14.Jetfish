...
namespace SS14.Jetfish.Migrations
{
    ...
    [Migration("20250910153204_UploadedFileIsConverting")]
    partial class UploadedFileIsConverting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SS14.Jetfish.Security.Model.User", b =>
                {
                    ...
                    b.Property<bool>("SettingAlwaysPlayAnimatedMedia")
                        .HasColumnType("boolean");
